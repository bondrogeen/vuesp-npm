...
var VuespDevices = /*#__PURE__*/function (_EventEmitter) {
  _inherits(VuespDevices, _EventEmitter);
  var _super = _createSuper(VuespDevices);
  function VuespDevices(list) {
    var _this;
    _classCallCheck(this, VuespDevices);
    _this = _super.call(this);
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _onEvent);
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _list, {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldSet(_assertThisInitialized(_this), _list, list);
  ...
  _createClass(VuespDevices, [{
      ...
      var _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _classPrivateFieldGet(this, _list).forEach(function (options, index) {
                _classPrivateFieldGet(_this2, _devices)[index] = new _device["default"](options);
                _classPrivateFieldGet(_this2, _devices)[index].on('*', function (payload) {
                  return _classPrivateMethodGet(_this2, _onEvent, _onEvent2).call(_this2, payload);
                });
              });
    ...
    key: "connection",
    value: function () {
      var _connection = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this3 = this;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              try {
                _classPrivateFieldGet(this, _list).forEach(function (_, index) {
                  _classPrivateFieldGet(_this3, _devices)[index].connect();
                });
...
exports.VuespDevices = VuespDevices;
